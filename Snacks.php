...
<body>
    ...
    <div class="navbar">
        <ul>
            ...
            <li><a class="active" href="Snacks.php">Snacks</a></li>
    ...
    <div class="bodypage">
        <div class="bodypagechild-side">
            <img src="Images/snacks.webp" width="400" height="400">
        ...
        <div class="bodypagechild-fresh" id="bodypagechild-fresh">
            <input id="searchbar" onkeyup="search_snacks()" type="text"
        ...
        <div class="bodypagechild-main" id="bodypagechild-main">
            <a href="#" onclick="javascript:displaySnack()">
                <div class="tomatoes">
                    <div class="t-image">
                        <img src="Images/snacks.webp" width="150" height="130">
                    </div>
                    <div class="t-text">
                        <h2>All Snacks</h2>
                    </div>
