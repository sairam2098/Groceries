...
<body>
    ...
    <div class="navbar">
        <ul>
            ...
            <li><a class="active" href="Pantry.php">Pantry</a></li>
    ...
    <div class="bodypage">
        <div class="bodypagechild-side">
            <img src="Images/pantry.jpg" width="400" height="400">
            <h3>
                <p>Essentials</p>
            </h3>
            <h2 id="time"></h2>
        ...
        <div class="bodypagechild-pantry" id="bodypagechild-pantry">
        </div>
        ...
        <div class="bodypagechild-veg" id="bodypagechild-veg">
        <?php
                include 'config.php';
                $category = 'Pantry';
                $subcategory = 'Pantry Veg';
        ...
        <div class="bodypagechild-spread" id="bodypagechild-spread">
        <?php
                include 'config.php';
                $category = 'Pantry';
                $subcategory = 'Pantry Spread';
        ...
        <div class="bodypagechild-main" id="bodypagechild-main">
            <a href="#" onclick="javascript:displayAllItems('.bodypagechild-pantry', '.bodypagechild-goods', '.bodypagechild-veg', '.bodypagechild-spread')">
                <div class="tomatoes">
                    <div class="t-image">
                        <img src="Images/pantry.jpg" width="150" height="130">
                    </div>
                    <div class="t-text">
                        <h2>All Pantry</h2>
                    </div>
            ...
            <a href="#" onclick="javascript:displayGoods()">
                <div class="tomatoes">
                    <div class="t-image">
                        <img src="Images/cannedgoods.jpg" width="150" height="130">
                    </div>
                    <div class="t-text">
                        <h2>Canned Goods</h2>
                    </div>
            ...
            <a href="#" onclick="javascript:displayVeg()">
                <div class="potatoes">
                    <div class="p-image">
                        <img src="Images/cannedveg.png" width="150" height="130">
                    </div>
                    <div class="p-text">
                        <h2>Canned Vegetables</h2>
                    </div>
                </div>
            </a>

            <a href="#" onclick="javascript:displaySpread()">
                <div class="cilantro">
                    <div class="c-image">
                        <img src="Images/spreads.png" width="150" height="130">
                    </div>
                    <div class="c-text">
                        <h2>Spreads</h2>
                    </div>
